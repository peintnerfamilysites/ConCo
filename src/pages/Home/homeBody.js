...
export default function createHomeBody(screenSize) {
  ...
  if (screenSizeInfo() === "mobile") {
    ...
    roofingAndGutterShowcase.classList.add(
      "home-body-roofing-and-gutter-showcase",
      "animate__animated",
      "animate__fadeIn",
    );
    ...
    garageDoorShowcase.classList.add(
      "home-body-garage-door-showcase",
      "animate__animated",
      "animate__fadeIn",
    );
